export default {
  global: {
    tweet: 'He votado en qué proyectos quiero que Ontinyent invierta'
  },
  option: {
    cost: 'Coste',
  ...
  booth_identification: {
    ...
    subheading: 'Puedes votar si tienes más de <strong>{min_age} años</strong> y estás empadronado en <strong>el barrio del Llombo</strong>',
  ...
  booth_receipt: {
    ...
    social: 'Invita tus amistades a participar y hagamos la Ontinyent que queremos entre todos y todas ;)',
